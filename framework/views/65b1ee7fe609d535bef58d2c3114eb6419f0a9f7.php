...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid w-50 d-flex justify-content-center">
        <p class="" style="background-color: #f5ec9a;">Register</p>
    </div>
    ...
    <div class="form-group container-fluid w-50 mb-3" style="background-color: #f5ec9a;">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Minimum 5 chars, maximum 50 chars">
    </div>
    <div class="form-group container-fluid w-50 mb-3" style="background-color: #f5ec9a;">
...
<?php echo $__env->make('form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH\KULIAH ODD 2324\WEB PROGRAMMING\LAB\WebProgramming_LAB_Project\resources\views/register.blade.php ENDPATH**/ ?>